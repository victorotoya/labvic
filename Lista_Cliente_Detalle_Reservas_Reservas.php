				...
				<tr>
					...
					<td><?php echo $row['telefono']; ?></td>
                        ...
                        <div class="text-right">
                            <a href="Listas_Reservas_Reservas.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-backward" aria-hidden="true"></span> Regresar</a>
                            <a href="Resultados.php?dni_cliente=<?php echo $row['dni'];?>" title="Sacar Cita" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Ver y Subir Resultados</a>
                        </div>
		</div>
	</div>
    </div>      
